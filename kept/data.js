...
const COUNTRIES = [
  ...
  { country: "Mexico", iso2: "mx", gdpRank: 12, grossUSD: 13885, taxPct: 13.2, taxUSD: 1833, netUSD: 12052, source: "Wage: INEGI/IMSS composite · Tax: OECD Taxing Wages 2026 brochure (2025)", confidence: "medium" },
  ...
  { country: "Belgium", iso2: "be", gdpRank: 23, grossUSD: 63924, taxPct: 39.5, taxUSD: 25250, netUSD: 38674, source: "Wage: UNECE 2024 · Tax: OECD Taxing Wages 2026 (2025) — highest tax rate in the OECD", confidence: "high" },
  ...
  // numbers.
  { country: "China", iso2: "cn", gdpRank: 2, grossUSD: 13226, taxPct: 11.2, taxUSD: 1475, netUSD: 11751, source: "Wage: NBS 2024 (weighted blend, urban units) · Tax: 2019 IIT brackets + 10.5% employee SSC — excludes ~290M migrant/informal workers", confidence: "low" },
  { country: "India", iso2: "in", gdpRank: 5, grossUSD: 2600, taxPct: 12.0, taxUSD: 312, netUSD: 2288, source: "Wage: NSO PLFS 2023-24, regular salaried only (~21% of workforce) · Tax: FY2025-26 new regime (₹0 due to rebate) + EPF 12%", confidence: "low" },
  ...
  { country: "Russia", iso2: "ru", gdpRank: 11, grossUSD: 14273, taxPct: 13.0, taxUSD: 1856, netUSD: 12417, source: "Wage: Rosstat 2025 · Tax: flat 13% income tax; 0% employee SSC (contributions are entirely employer-paid in Russia)", confidence: "medium" },
  { country: "Indonesia", iso2: "id", gdpRank: 16, grossUSD: 2211, taxPct: 4.0, taxUSD: 88, netUSD: 2123, source: "Wage: BPS Sakernas Aug 2024, wage employees only (<50% of workforce) · Tax: below PTKP threshold (₹0) + BPJS ~4%", confidence: "low" },
  { country: "Saudi Arabia", iso2: "sa", gdpRank: 19, grossUSD: 32381, taxPct: 9.8, taxUSD: 3157, netUSD: 29224, source: "Wage: GASTAT 2024, Saudi nationals only (excludes ~75% expat private-sector majority) · Tax: 0% income tax + GOSI 9.75%", confidence: "medium" },
  ...
  { country: "Argentina", iso2: "ar", gdpRank: 24, grossUSD: 15225, taxPct: 17.0, taxUSD: 2589, netUSD: 12637, source: "Wage: INDEC/RIPTE June 2026 · Tax: below Ganancias threshold (₳0) + 17% employee SSC — peso figure highly date-sensitive amid inflation/FX volatility", confidence: "low" },
  ...
  { country: "United Arab Emirates", iso2: "ae", gdpRank: 29, grossUSD: 52281, taxPct: 0.0, taxUSD: 0, netUSD: 52281, source: "Wage: private salary-survey estimate — no official government release located · Tax: 0% income tax, 0% SSC for the expatriate majority", confidence: "low" },
];
